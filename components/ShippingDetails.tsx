...
const ShippingDetails = () => {
    ...
    return (
        <div className='flex flex-col items-center mb-[30px]'>
            <div className='hidden lg:block lg:w-[30rem] flex flex-col items-center shadow-lg rounded'>
                <div onClick={() => setItemsDisplay(!itemsDisplay)} className='w-full flex flex-col'>
                    <div className='bg-yellow-400 flex justify-between p-[10px] text-black mt-[20px] cursor-pointer'>
                        <p className='w-full text-center font-bold font-poppins'>
                ...
                <div className='w-full flex flex-col items-center bg-slate-200 pb-[30px]'>
                    <div className='flex items-center gap-[10px] py-[15px]'>
                        <p className='font-poppins font-bold px-[10px] text-center underline underline-offset-4 decoration-violet-800'>
                    ...
                    <div className='w-full bg-yellow-400 p-[10px]'>
                        <p className='font-[poppins] p-[10px] text-center'>
            ...
            <div className='w-full lg:hidden'>
                <div onClick={() => setItemsDisplay(!itemsDisplay)} className='w-full flex flex-col'>
                    <div className='w-full bg-yellow-400 flex justify-between p-[10px] text-black mt-[20px] cursor-pointer'>
                ...
                <form className='w-full flex flex-col'>
                    ...
                    <div className='w-full bg-yellow-400 p-[10px]'>
                        <p className='w-full font-[poppins] p-[10px] text-center'>
                            Check your details carefully.
                        </p>
